...
String.prototype.reverse = function(){
    const stringAsArr = this.split("");
    const reversedStringAsArr = [];
    stringAsArr.forEach((val, idx, arr) => {
        reversedStringAsArr.push(arr[stringAsArr.length - 1 - idx])
    })
    return reversedStringAsArr.join('');
}